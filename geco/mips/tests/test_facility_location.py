...
def test_capacitated_facility_location():
    ...
    instance_params = cornuejols_instance_params(n_customers, n_facilities, seed=0)
    model = capacitated_facility_location(n_customers, n_facilities, ratio, *instance_params)
